# Implementation of card game in CodeSkulptor - Memory
...
def init():
    ...
    numlist = range(0,8)
    numlist.extend(range(0,8)) # concatenation, adds a group of elements 
...
def mouseclick(pos):
    ...
    index = int(pos[0]/WIDTH) # step 5, print index
    if state == 0:
        if(exposed[index] == 0):
